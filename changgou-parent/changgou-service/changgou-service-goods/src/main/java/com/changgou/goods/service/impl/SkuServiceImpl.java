...
public class SkuServiceImpl implements SkuService {
     ...
     */
    @Override
    public void decrSkuNum(Map<String, Object> decrData) {
        //遍历集合
        Set<Map.Entry<String, Object>> entrySet = decrData.entrySet();
        for (Map.Entry<String, Object> entry : entrySet) {
            ...
            //减库存
            int i = skuMapper.decrSkuNum(skuId, num);
            if (i <= 0) {
                throw new ChanggouException("库存不足,下单失败");
            }
        }
    }
 ...
 */
    @Override
    public void updateNum(String skid,Integer count) {
        //查询sku信息
        Sku sku = skuMapper.selectByPrimaryKey(skid);
        //售卖出多少个商品?count
        //上架多少个商品
