...
public class BrandController {
     ...
     *
     * @param cid :
     * @return : com.changgou.util.Result<java.util.List<com.changgou.goods.pojo.Brand>>
     */
    @GetMapping(value = "/category/{cid}")
    public Result<List<Brand>> findByCategoryId(@PathVariable(value = "cid") Integer cid) {
        List<Brand> brands = brandService.findByCategoryId(cid);
